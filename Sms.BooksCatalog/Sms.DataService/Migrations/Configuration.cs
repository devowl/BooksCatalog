namespace Sms.DataService.Migrations
{
    ...
    internal sealed class Configuration : DbMigrationsConfiguration<DatabaseContext>
    {
        ...
        {
            //разрешаем автомиграцию, данны важных нету, будем тереть
            AutomaticMigrationsEnabled = true;
        }

        /// <summary>
        /// Seed метод будет вызываться при каждом обновлении базы
        /// </summary>
        ...
        protected override void Seed(DatabaseContext context)
        {
            ...
            context.Books.AddOrUpdate(book1, book2, book3);//Что бы сразу несколько в базу засунуть
            ...
            context.Catalogs.AddOrUpdate(catalog1, catalog2, catalog3); //Что бы сразу несколько в базу засунуть
        }
    }
}
